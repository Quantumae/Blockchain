...
async function main(): Promise<void>
{
    ...
    try {
        ...
        console.log('*** Returned all assets successfully')
        ...
        console.log('*** Updated asset asynchronously')

        // Get the asset details by assetID.
        await readAssetByID(contract);
        console.log('*** Read asset details successfully')

        // Update an asset which does not exist.
        await updateNonExistentAsset(contract)
        console.log('*** Updated non-existent asset successfully')
    } finally {
        gateway.close();
        client.close();
    }
